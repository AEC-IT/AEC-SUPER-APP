...
class Booking(models.Model):
    ...
    # ── Tenant Foundation ────────────────────────────────────────────────────
    # Direct FK added to make Booking explicitly tenant-scoped.
    # Backfilled in migration 0004_booking_backfill_tenant via show.screen.tenant.
    # Nullable=True only during migration; application code always sets this.
